...
* **박현아**
  ...
  >
  > 무엇보다 혼자 하는 것에 익숙했던 제가 팀원들과 역할을 나누고 하나의 목표를 향해 4개월 동안 함께 달려간 경험이 큰 의미로 남았습니다. AI라는 강력한 제3의 팀원이 하나 더 있었지만, 결국 GitHub와 Discord에서 계속 소통하며 팀원들과 레포를 채워갔습니다. 서로 다른 전공과 강점을 가진 사람들이 모여 하나의 결과물을 완성했다는 것이 뿌듯했고, 이 레포를 다시 돌아보는 지금도 그 과정이 꽤 즐겁게 느껴집니다.
  >
