...
이 절은 현재 구현과 목표 기능을 함께 설명합니다. 각 기능의 정확한 상태는 12절의 표와 [구현 상태 문서](.ai/IMPLEMENTATION_STATUS.md)를 함께 확인합니다.
...
모이라 스튜디오는 주민 제안과 지역 수요를 바탕으로 사서의 프로그램 기획안 생성·검토·수정과 사전 수요 확인을 지원하는 목표 기능입니다. 현재 AI API, 유사 사례 검색 및 기획안 생성 코드는 구현되지 않았습니다. 자세한 제품 의도와 사용자 흐름은 [.ai/PROJECT.md](.ai/PROJECT.md)를 참고합니다.
