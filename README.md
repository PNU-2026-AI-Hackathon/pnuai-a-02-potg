<div align="center">
  ...
  <p>
    주민의 아이디어에서 시작해 작은도서관 프로그램 기획과 수요조사까지 연결하는<br />
    AI 기반 주민 참여형 도서관 프로그램 기획 지원 플랫폼
  </p>
  <p>
    지역 주민은 원하는 프로그램을 제안하고, 사서와 프로그램 기획 담당자는 MOIRA Studio로<br />
    주민 의견과 기존 프로그램 사례를 바탕으로 기획안 초안을 만들 수 있습니다.
  </p>
  <p>
    <em>제7회 PNU 창의융합 AI 해커톤 · 팀 POTG</em>
  </p>
  <p>
    <strong>라이브 데모</strong> —
