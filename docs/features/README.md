...
- 대상: 이슈 106건, PR 107건 (사용법 연습·테스트용 이슈 3건, PR 4건 제외)
...
| [F08](#f08-기획안-생성) | MOIRA STUDIO | 기획안 생성 | 사서 | 5 | 10건 | 11건 | 2026-07-21 ~ 2026-08-18 |
...
> **구분** MOIRA STUDIO · **주요 내용** 직접 입력 또는 주민 아이디어 기반 AI 초안 생성 · **권한** 사서
> 
> **기간** 2026-07-21 ~ 2026-08-18 · **PR** 10건

빈 화면에서 LLM 초안 생성을 붙이고, 여기에 B01의 사례 검색을 결합해 기존 프로그램을 근거로 삼는 초안으로 바꿨습니다. 마지막에 주민 아이디어를 입력으로 받는 두 번째 모드를 추가했습니다.
